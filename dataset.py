...
class TextDataset(Dataset):
    ...
    def __getitem__(self, idx):
        return {
            ...
            "attention_mask": self.encodings.attention_mask[idx].to(self.device) # The attention mask is a tensor that tells the model which parts of the input sequence are real data (tokens of the original text) and which parts are just padding.
        }
